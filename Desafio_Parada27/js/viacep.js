function limpa_formulario(){
    ...
    document.getElementById("i_sobrenome").value = ("");
...
function atualiza_formulario(conteudo){
    ...
    if(!("erro" in conteudo)){
        ...
        document.getElementById("i_nome").value = (conteudo.nome);
        document.getElementById("i_sobrenome").value = (conteudo.sobrenome);
        document.getElementById("i_email").value = (conteudo.email);
